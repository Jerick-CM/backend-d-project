                      ...
                      <td valign="middle" align="left" style="text-align:left;padding:2px 0px 0px 0px;margin:0;width:100%;" class="fluid">
                        <span>
                          ...
                          <?php } ?>                              
                              ...
                              <img src="{{$header2}}" width="640" style="float: left; width: 100%; border: 0 !important; outline: 0 !important; border-style: none !important;" alt="A.C.E. Your rewards are here!" class="fluid">
                      ...
                      <tr>
                        <td style="padding:2px 6% 25px 6%;color:#808080;font-family: Calibri, 'Roboto', Helvetica, Arial, sans-serif;font-size:15px; line-height: 22px;text-align:left; font-weight: 400;">
                              ...
                              @foreach ($orderItems as $item)
                                  <tr>
                                    ...
                                    <td class="one-col-mobile-r" width="65%" style="float: right;padding: 15px 10px 0px 10px;">
                                      {{ $placeholder5 }} Product: {{ $item['inventory']->name }}
                                      <br>
                                      {{ $placeholder6 }}  Quantity: {{ $item['quantity'] }}
                                      <br>
                                      {{ $placeholder7 }}  Tokens used: {{ $item['tokens'] }}
                                    </td>
                                  </tr>
                              @endforeach
                            </table>
                          ...
                          <!-- <b> {{ $placeholder8 }} -->
                            ...
                            <!-- </b>  -->
                          <!-- {{ $placeholder9 }} -->
                           <!-- tokens balance:  {{ $remainingToken }} -->
                          <!-- <br><br> -->
                           <!-- {{ $placeholder10 }} -->
                          <!-- Please collect your items from us on: -->
                          <!-- <br><br> -->
                          <!-- <b style="color: #92d050">{{ $placeholder11 }} -->
                            <!-- Collection date/time: -->
                              
                            <!-- </b>  {{ $collectionDate }} -->
                          <!-- <br><br> -->
                          <!-- <b style="color: #92d050">{{ $placeholder12 }} -->
                            <!-- Collection location: -->
                          ...
                          <!-- <br><br> -->
                           <!-- {!! $placeholder15 !!} -->
                          <!-- To view your redemption history to date, please click <a style="color:#86BC25;text-decoration:none;" href="{{$historyLink}}" target="_blank">here</a>. -->
                          </p>
                        </td>
                      </tr>
                    </table>
