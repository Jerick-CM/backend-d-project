...
<body>
    ...
    <p>
        <div>This email is to confirm that you sent <strong>{{ $token }} tokens</strong> to <strong>{{ $recipient->name }}</strong></div>
    ...
    <div class="message-container">
        <div class="message">
            <div class="message-header">
                ...
                <div class="details">
                    <div class="details-name">{{ $recipient->name }}</div>
                    <div class="details-position">{{ $recipient->position_name }}</div>
                </div>
            </div>
            ...
            <div class="message-footer">
                <div class="footer-name">From {{ $user->name }}</div>
                <div>{{ $date }} | {{ $time }}</div>
            </div>
        </div>
    </div>
