...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Calibri, 'Roboto', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
  <!-- In recognition of { NAME }'s excellent work, you’ve sent a badge! Here's what you said. -->
  {{ $preheadertext3 }}
</div>
                  ...
                  <tr>
                    <td valign="middle" align="left" style="text-align:left;padding:2px 0px 0px 0px;margin:0;width:100%;" class="fluid">
                      <span>
                        ...
                        <img src="{{$header2}}" width="640" style="float: left; width: 100%; border: 0 !important; outline: 0 !important; border-style: none !important;" alt="A.C.E. Showing appreciation" class="fluid">
                    ...
                    <table align="left" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td style="padding:2px 40px 25px 40px;color:#808080;font-family: Calibri, 'Roboto', Helvetica, Arial, sans-serif;font-size:15px; line-height: 22px;text-align:left; font-weight: 400;">
                          ...
                          <!-- <br><br> -->
                            <!-- {{ $placeholder2 }} -->
                          <!-- You have sent your appreciation to {{ $recipientName }} for being a great help at work and have awarded {{ $recipientName }} with {{ $linkingVerb }} {!! $badgeType !!} badge with the following message: -->
                          <!-- <br><br> -->
                          <!-- {!! $messageContent !!} -->
                          <!-- <br><br> -->
                            <!-- {{ $placeholder3 }} <b> {{ $placeholder4 }}</b> {{ $placeholder5 }} -->
                          <!-- In addition, you have awarded {{ $recipientName }} with {{ $token }} <b>"Recognise Others"</b> tokens. -->
                          <!-- <br><br> -->

                          <!-- {{ $placeholder6 }} -->
                          <!-- Thank you for recognising the hard work and effort put in by our people who have gone the extra mile! -->
                        </td>
                      </tr>
                    </table>
                  </td>
