...
class Returbackmeuicons extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('pages', function ($table) {
              ...
              DB::statement("INSERT INTO `pages` (`id`, `name`, `title`, `content`, `icon`, `pageurl`, `reserved`, `priority`, `publish`, `created_at`, `updated_at`) VALUES
                    ...
                    (5, 'Contact Us', 'Contact Us', '<p>Reserved</p>', 'public/img/menu/call-white-18dp.svg', 'faq#contact-us', 1, 5, 1, '2020-08-17 06:31:11', '2020-08-17 06:31:11'),
                    
                    (6, 'test baby again', 'test', '<p>test cms page </p>', 'public/img/menu/article-white-18dp.svg', 'test-baby-again-1597932158', 0, 6, 0, '2020-08-17 19:34:18', '2020-08-20 06:02:38');");
